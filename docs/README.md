...
| 主題 | 文件 |
| --- | --- |
| V2架構及相容邊界 | [`features/v2-modernization.zh-TW.md`](features/v2-modernization.zh-TW.md) |
| 測試、輸出及效能 | [`features/validation-and-performance.zh-TW.md`](features/validation-and-performance.zh-TW.md) |
| 發行、下載及Overleaf | [`features/release-and-distribution.zh-TW.md`](features/release-and-distribution.zh-TW.md) |
...
既有Overleaf Gallery頁面仍可公開使用。本模版的V2 update已提交review；在Overleaf批准並完成public read-back前，該頁面不代表最新V2 package。詳細狀態記錄於[`features/release-and-distribution.zh-TW.md`](features/release-and-distribution.zh-TW.md)。
