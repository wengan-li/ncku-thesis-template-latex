<!-- language: zh-Hant-TW; summary-of: validation-and-performance.md -->
...
Production evidence已整合至[`v2.0.1.260719010734`](https://github.com/wengan-li/ncku-thesis-template-latex/releases/tag/v2.0.1.260719010734)。
...
完整英文technical record：[validation-and-performance.md](validation-and-performance.md)
