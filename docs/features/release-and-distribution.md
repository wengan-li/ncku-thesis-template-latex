<!-- language: en; summary: release-and-distribution.zh-TW.md -->
...
[`validation-and-performance.md`](validation-and-performance.md#current-production-release-read-back).
...
- [`v1-to-v2-migration.md`](../v1-to-v2-migration.en.md) — full migration contract.
- [`validation-and-performance.md`](validation-and-performance.md) — current
