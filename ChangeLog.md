...
+ **更新**:
  1. 跟隨[學位考試系統](http://etds.lib.ncku.edu.tw/files/2012050003.pdf)中, 在2018年下學期時，開始需要插入DOI碼，故在`conf.tex`中加入`\ShowDOI{}`. \([感謝ChampDBG提供Pull request \#35](https://github.com/wengan-li/ncku-thesis-template-latex/pull/35)\)
