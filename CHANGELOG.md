<!-- language: zh-Hant-TW; companion: CHANGELOG.en.md -->

[繁體中文](CHANGELOG.md) | [English](CHANGELOG.en.md)

# 變更記錄

本文件記錄各次正式發行及使用者可見修正。學生套件及examples可從[GitHub Releases](https://github.com/wengan-li/ncku-thesis-template-latex/releases)下載。現行學校及系所規定永遠優先於本範本說明。
...
- 文件：升級指南的相容性證據一節改為連結至擁有該數字的記錄，repo-maintenance skill不再重複examples套件清單，並加入v2.0.5公開read-back紀錄。
