...
\newcommand{\StartOralTempleteDocChi}
{
...
\newcommand{\StartOralTempleteDocEng}
{
  %
  \UseEngLinesSpacing
  %
...
\newcommand{\DisplayOralTemplete}{\DisplayOralTemplate} % For backporting
