...
%  \center\normalsize\textit{\GetCollEngName}\\%
  ...
  \captionsetup[table]{tablename=Table, font=bf}
  \captionsetup[figure]{figurename=Figure, font=bf}
} % End of \newcommand{}
...
\newcommand{\EndExtendedAbstract}
{
  ...
  %
  % Reset style of caption of fingure and table
  \captionsetup[table]{tablename=Table, labelfont=bf, textfont=normalfont}
  \captionsetup[figure]{figurename=Figure, labelfont=bf, textfont=normalfont}
  %
