...
\newcommand{\DisplayTitleHeader}[2]
{%
  \pgfkeys{/DisplayTitleHeader, default, #2}%
  \ifboolexpr{%
      ...
      {%
       \vspace*{0pt}%
        {%
          ...
          \Large\bf \TmpValueLabelString \par%
          \vskip 15pt%
          \Large \bf \TmpValueTextString \par%
          \nobreak%
      %    \vskip 35pt%
          \vskip 25pt%
        }%
        \addcontentsline{%
          toc}{chapter}{%
          \TmpValueLabelString\TmpValueSepAtIndex\TmpValueSpacesAtIndex\TmpValueTextString}%
        \addtocontents{lof}{\protect\addvspace{10 pt}}
        \addtocontents{lot}{\protect\addvspace{10 pt}}
      }{}%
  %
  \ifboolexpr{%
    test {\ifstrequal{#1}{ChapterStar}} }
      {%
        \vspace*{0pt}%
        {%
          \parindent 0pt \centering \Large \bf \TmpValueTextString \par%
          \nobreak%
      %    \vskip 30pt%
          \vskip 20pt%
        }%
        \addcontentsline{toc}{chapter}{\TmpValueTextString}%
      }{}%
  %
  \ifboolexpr{%
    ...
    test {\ifstrequal{#1}{AppendixSection}} }
      {%
        \vspace{0.5cm}%
        \ifthenelse{\equal{\TmpValueLabelString}{\empty}}%
        {%
          \parindent 0pt \textbf{\TmpValueTextString} \par%
        }%
        {%
          \parindent 0pt \textbf{\TmpValueLabelString\hspace{0.5cm}\TmpValueTextString} \par%
        }%
        \vspace{0.1cm}%
        \addcontentsline{%
          toc}{section}{%
...
\begin{comment}
\newcommand{\DisplayChapterHeader}[3]%
{%
 \vspace*{0pt}%
  {%
    \parindent 0pt \centering%
...
{%
  ...
  {%
    ...
    %
    %    Starred
    \DisplayTitleHeader{ChapterStar}%
    {TextString=#2}%
...
%      \DisplayChapterHeader{%
%        \GetAppendixChapterTitleNumberFormatString}{%
%        \GetAppendixCTitleNumberFormatSepAtIndex}{%
%        #2}%
%
      \DisplayTitleHeader{AppendixChapter}%
      {%
        LabelString=\GetAppendixChapterTitleNumberFormatString,%
        SepAtIndex=\GetAppendixCTitleNumberFormatSepAtIndex,%
        TextString=#2,%
      }%
    }%
    {%
...
%\protect\GetChapterTitleNumberFormatCNumStyle 123
%      \DisplayChapterHeader{\GetChapterTitleNumberFormatBeginText\GetChapterTitleNumberFormatCNumVaule}{#2}

\SetupChapterTitleNumberFormatString
%\ValueChapterTitleNumberingFormat
      \DisplayTitleHeader{Chapter}%
      {%
        LabelString=\GetChapterTitleNumberFormatString,%
        SepAtIndex=\GetCTitleNumberFormatSepAtIndex,%
        TextString=#2,%
      }%
%      \DisplayChapterHeader{%
%        \GetChapterTitleNumberFormatString}{%
%        \GetCTitleNumberFormatSepAtIndex}{%
%        #2}%

%      \DisplayChapterHeader{\ValueChapterTitleNumberingFormat}{#2}
%\stop
%      \DisplayChapterHeader{\GetChapterTitleNumberingFormat}{#2}
...
{%
  ...
  \vspace{0.1cm}%
  \addcontentsline{%
    toc}{section}{#1\VarSectionHeaderSeparatorInToc{\ \ \ }#2}%
} % End of \newcommand{}
\end{comment}
...
%      \DisplaySectionHeader{\ValueAppendixSectionTitleNumberingFormat}{#2}
      ...
      \DisplayTitleHeader{AppendixSection}%
      {%
        LabelString=\GetAppendixSectionTitleNumberFormatString,%
...
%      \DisplaySectionHeader{\ValueSectionTitleNumberingFormat}{#2}
      ...
      \DisplayTitleHeader{Section}%
      {%
        LabelString=\GetSectionTitleNumberFormatString,%
...
{%
  ...
  \vspace{0.1cm}%
  \addcontentsline{%
    toc}{subsection}{#1\VarSubSectionHeaderSeparatorInToc{\ \ \ }#2}%
} % End of \newcommand{}
\end{comment}
...
%        \ValueAppendixSubSectionTitleNumberingFormat}{#2}
      ...
      \DisplayTitleHeader{AppendixSubSection}%
      {%
        LabelString=\GetAppendixSubSectionTitleNumberFormatString,%
...
%        \ValueSubSectionTitleNumberingFormat}{#2}
      ...
      \DisplayTitleHeader{SubSection}%
      {%
        LabelString=\GetSubSectionTitleNumberFormatString,%
...
{%
  ...
  \vspace{0.1cm}%
  \addcontentsline{%
    toc}{subsubsection}{#1\VarSubSubSectionHeaderSeparatorInToc{\ \ \ }#2}%
} % End of \newcommand{}
\end{comment}
...
%        \ValueAppendixSubSubSectionTitleNumberingFormat}{#2}
      ...
      \DisplayTitleHeader{AppendixSubSubSection}%
      {%
        LabelString=\GetAppendixSubSubSectionTitleNumberFormatString,%
...
%        \ValueSubSubSectionTitleNumberingFormat}{#2}
      ...
      \DisplayTitleHeader{SubSubSection}%
      {%
        LabelString=\GetSubSubSectionTitleNumberFormatString,%
...
%  {%
%    \ifthenelse{\equal{\GetStartAppendixChapter}{\ValueEnableAppendixChapter}}%
%    {\LabelThisAs{#2}{\GetCounterNumberAppixChapterNumber}}%
%    {\LabelThisAs{#2}{\GetCounterNumberChapterNumber}}%
%  }%
