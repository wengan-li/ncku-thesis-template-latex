...
%        Non-Starred
    ...
    \ifthenelse{\equal{\GetStartAppendixChapter}{\ValueEnableAppendixChapter}}%
    {%
       \parindent 0pt \textbf{\ValueAppendixSectionTitleNumberingFormat\hspace{0.5cm}#2} \par \vspace{0.1cm}%
    }%
    {%
       \parindent 0pt \textbf{\ValueSectionTitleNumberingFormat\hspace{0.5cm}#2} \par \vspace{0.1cm}%
    }%
    %
  }%
} % End of \RenewDocumentCommand{}
