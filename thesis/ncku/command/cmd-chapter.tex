...
{%
  ...
  %
  \IfNoValueF{#3}{\LabelThisAs{#3}{#1}}%
} % End of \newcommand{}

\RenewDocumentCommand{\section}{s m m}
{%
  %
...
%        Non-Starred
    ...
    {%
      ...
      \DisplaySectionHeader{\GetAppendixSectionTitleNumberFormatString}{#2}{#3}%
    }%
    {%
      \refstepcounter{section}%
      \SetupSectionTitleNumberFormatString%
      \DisplaySectionHeader{\GetSectionTitleNumberFormatString}{#2}{#3}%
    }%
  }%
  % Reset counters
...
\RenewDocumentCommand{\subsection}{s m m}
{%
  %
...
%        Non-Starred
    ...
    {%
      ...
      \DisplaySubSectionHeader{%
        \GetAppendixSubSectionTitleNumberFormatString}{#2}{#3}%
    }%
    {%
      \refstepcounter{subsection}%
      \SetupSubSectionTitleNumberFormatString%
      \DisplaySubSectionHeader{%
        \GetSubSectionTitleNumberFormatString}{#2}{#3}%
    }%
  }%
  % Reset counters
...
\RenewDocumentCommand{\subsubsection}{s m m}
{%
  %
...
%        Non-Starred
    ...
    {%
      ...
      \DisplaySubSubSectionHeader{%
        \GetAppendixSubSubSectionTitleNumberFormatString}{#2}{#3}%
    }%
    {%
      \refstepcounter{subsubsection}%
      \SetupSubSubSectionTitleNumberFormatString%
      \DisplaySubSubSectionHeader{%
        \GetSubSubSectionTitleNumberFormatString}{#2}{#3}%
    }%
  }%
} % End of \RenewDocumentCommand{}
