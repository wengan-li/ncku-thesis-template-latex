...
{%
  ...
  %
  % Set numbering format style for figure/table/equation
  \renewcommand{\thefigure}{\Alph{appendixchapter}.\arabic{figure}}
  \renewcommand{\thetable}{\Alph{appendixchapter}.\arabic{table}}
  \renewcommand{\theequation}{\Alph{appendixchapter}.\arabic{equation}}
  %
  \StartNewPage%
} % End of \newcommand{}
