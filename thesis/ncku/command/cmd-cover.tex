...
\newcommand{\GetOralYearInTaiwanYear}[0]
...
{
  \begin{document}
  \input{./ncku/cover/cover}
  \end{document}
} % End of \newcommand{}

% Use to include and display inner cover
\newcommand{\DisplayInnerCover}{\input{./ncku/cover/inner.tex}}
...
\newcommand{\DisplayCoverInChi}[0]{\renewcommand{\VarDisplayCoverLang}{\ValueDisplayCoverLangChi}}
\newcommand{\DisplayCoverInEng}[0]{\renewcommand{\VarDisplayCoverLang}{\ValueDisplayCoverLangEng}}
...
\newcommand{\CDBothName}[0]{\SetCDBothName}
