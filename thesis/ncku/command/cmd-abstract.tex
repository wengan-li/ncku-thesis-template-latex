...
%  \addcontentsline{toc}{chapter}{Extended Abstract}
  ...
  %
  % Add names
  \centerline{\GetAuthorEngName}
  \centerline{Dr. \thinspace \GetAdvisorEngNameA}
  \ifthenelse{\equal{\GetAdvisorEngNameB}{\empty}}
    {}
    {\centerline{Dr. \thinspace \GetAdvisorEngNameB}}
  %
  \ifthenelse{\equal{\GetAdvisorEngNameC}{\empty}}
    {}
    {\centerline{Dr. \thinspace \GetAdvisorEngNameC}}
  %
  % Add department
...
\newcommand{\ExtAbstractSummary}[1]{
  \begin{framed}
    ...
    % Keyword
    \par
    {\noindent \bf Keyword:} \GetAbstractExtKeywords
  \end{framed}
} % End of \newcommand{}
