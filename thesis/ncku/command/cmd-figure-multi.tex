  ...
  +G{\empty} +G{\empty} +G{\empty} +G{\empty}}
{
  ...
  \ifthenelse{\equal{#2}{\empty}}{}%
  {
    ...
    \InsertSubfigureBox{1.0}{#2}
  }%
  %
  \ifthenelse{\equal{#3}{\empty}}{}%
  {

    \InsertSubfigureBox{1.0}{#3}
  }%  %
  \ifthenelse{\equal{#4}{\empty}}{}%
  {

    \InsertSubfigureBox{1.0}{#4}
  }%  %
  \ifthenelse{\equal{#5}{\empty}}{}%
  {

    \InsertSubfigureBox{1.0}{#5}
  }%  %
  \ifthenelse{\equal{#6}{\empty}}{}%
  {

    \InsertSubfigureBox{1.0}{#6}
  }%  %
  \ifthenelse{\equal{#7}{\empty}}{}%
  {

    \InsertSubfigureBox{1.0}{#7}
  }%  %
  \ifthenelse{\equal{#8}{\empty}}{}%
  {

    \InsertSubfigureBox{1.0}{#8}
  }%
} % End of \newcommand{}
  ...
  +G{\empty} +G{\empty} +G{\empty} +G{\empty}}
{
  ...
  }%
  {
    ...
    \InsertSubfigureBox{0.5}{#3}%
    ~
    \InsertSubfigureBox{0.5}{#4}%
  }%
  %
  \ifthenelse{\equal{#6}{\empty}}%
  {
  ...
  }%
  {
    ...
    \InsertSubfigureBox{0.5}{#5}%
    ~
    \InsertSubfigureBox{0.5}{#6}%
  }%
  %
  \ifthenelse{\equal{#8}{\empty}}%
  {
  ...
  }%
  {
    ...
    \InsertSubfigureBox{0.5}{#7}%
    ~
    \InsertSubfigureBox{0.5}{#8}%
  }%
} % End of \newcommand{}
