...
% NCKU-owned college and department catalogue. Keep this profile-scoped so a
% custom institution loads only the portable metadata contract from base/command.
...
% NCKU degree-examination committee ranges. Keep the generic renderer capable
% of 2--9 signatures; this profile owns the degree-specific policy.
\renewcommand{\ApplyCommitteeSizePolicy}[1]{%
  \ifthenelse{\equal{\GetFlagDegreeType}{\ValueDegreeMaster}}%
    {%
      \ifthenelse{#1 < 3}
        {\renewcommand{\CommitteeSize}{3}}
        {\ifthenelse{#1 > 5}
          {\renewcommand{\CommitteeSize}{5}}
...
% NCKU legacy oral-template certificates carry the institutional watermark:
% the text style on the Chinese page and the logo figure on the English page.
\renewcommand{\ApplyOralTemplateChiWatermarkPolicy}{\UseWatermarkTextStyle}
\renewcommand{\ApplyOralTemplateEngWatermarkPolicy}{\UseWatermarkFigureStyle}
