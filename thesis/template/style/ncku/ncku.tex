...
% NCKU uses the oral date as the authoritative cover date. Keep this
% two-argument command as a compatibility no-op without consuming the next token.
\renewcommand{\SetCoverDate}[2]
{%
