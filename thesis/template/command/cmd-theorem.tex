...
{%
  ...
  {%
  \PackageWarning{fred}{MappingTheoremCounter}
  \PackageWarning{fred}{#2}
  \PackageWarning{fred}{#1}
  ...
  %
  \ifthenelse{\equal{#1}{Conjectures}}%
  {%
    \renewcommand{\GetTheoremConjecturesFormatFollowCounter}{#2}%
  }{}%
  %
