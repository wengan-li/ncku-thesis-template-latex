...
\DeclareDocumentCommand{\DisplaySectionHeader}{m m m O{1}}%
{%
  \par%
  \vspace{0.5cm}%
  %
...
{%
  ...
  {%
    % \section*{}
    \DisplaySectionHeader{\empty}{#2}{\GetSTitleNumberFormatTextAlign}[0]%
  }%
  {%
    % \section{}
%        Non-Starred
...
\DeclareDocumentCommand{\DisplaySubSectionHeader}{m m m O{1}}%
{%
  \par%
  \vspace{0.5cm}%
  %
...
{%
  ...
  {%
    % \subsection*{}
    \DisplaySubSectionHeader{\empty}{#2}{\GetSSTitleNumberFormatTextAlign}[0]%
  }%
  {%
    % \subsection{}
%        Non-Starred
...
\DeclareDocumentCommand{\DisplaySubSubSectionHeader}{m m m O{1}}%
{%
  \par%
  \vspace{0.5cm}%
  %
...
{%
  ...
  {%
    % \subsubsection*{}
    \DisplaySubSubSectionHeader{\empty}{#2}{\GetSSSTitleNumberFormatTextAlign}[0]%
  }%
  {%
    % \subsubsection{}
%        Non-Starred
