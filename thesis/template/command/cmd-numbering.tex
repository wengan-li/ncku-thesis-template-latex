...
% Keep the remaining numbering key families behind one private routing seam.
% The family name stays explicit so each parser can be migrated and asserted
% independently without changing public numbering commands.
\newcommand\NCKUPrivateSetRemainingNumberingKeys[2]
{%
  \pgfkeys{/#1, default, #2}%
} % End of \newcommand{}
