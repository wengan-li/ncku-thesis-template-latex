...
% Mode
\newcommand{\ExampleMode}{\renewcommand{\ValueDemoMode}{\VarDemoModeOn}}
\newcommand{\StudentMode}{\renewcommand{\ValueDemoMode}{\VarDemoModeOff}}
\newcommand{\DemoMode}{\ExampleMode} % Backward-compatible name
