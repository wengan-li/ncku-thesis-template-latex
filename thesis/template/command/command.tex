...
% Generic watermark mechanism. Institution assets/styles belong to profiles.
\input{./template/command/cmd-watermark}

% V1 compatibility facade kept throughout the complete 2.x line.
\input{./template/compat/v1}
