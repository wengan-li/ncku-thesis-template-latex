...
\newcommand\VarUniversityChiName{University}           % Profile sets default
\newcommand\VarUniversityEngName{University}           % Profile sets default
...
% --- 論文的日期 ---
\newcommand{\ThesisYear}{2014}  % Resolved cover year
\newcommand{\ThesisMonth}{1}    % Resolved cover month
\newcommand{\VarRequestedCoverYear}{2014}
\newcommand{\VarRequestedCoverMonth}{1}
\SetThesisTaiwanYear{\ThesisYear}

% Institution profiles customize these policy hooks instead of redefining the
% public date setters.
\newcommand{\ApplyCoverDatePolicy}[2]{%
  \SetThesisTaiwanYear{#1}%
  \renewcommand{\ThesisYear}{#1}%
  \renewcommand{\ThesisMonth}{#2}%
}
\newcommand{\ApplyOralDatePolicy}[3]{}
\newcommand{\ApplyOralChiYearPolicy}[1]{\renewcommand{\OralChiYear}{#1}}

\newcommand{\SetThesisDate}[2]{\SetCoverDate{#1}{#2}} % Backward-compatible name
\newcommand{\SetCoverDate}[2]
{
  \renewcommand{\VarRequestedCoverYear}{#1}%
  \renewcommand{\VarRequestedCoverMonth}{#2}%
  \ApplyCoverDatePolicy{#1}{#2}%
} % End of \newcommand{}

\newcommand{\GetRequestedCoverYear}{\VarRequestedCoverYear}
\newcommand{\GetRequestedCoverMonth}{\VarRequestedCoverMonth}
...
\SetOralTaiwanYear{\OralEngYear}

\newcommand{\GetOralChiYear}{\OralChiYear}
\newcommand{\GetOralYearInTaiwanYear}{\OralTaiwanYearResult}
\newcommand{\GetOralYearInTaiwanYearNumInChi}{\zhdigits{\OralTaiwanYearResult}}
...
\newcommand{\VarDepartmentEngFullName}{Department / Institute A} % Full name of department
...
\newcommand{\GetDeptEngShortName}{\VarDepartmentEngName}
...
\newcommand{\DisableFlagDisplayDraft}{\renewcommand{\VarCoverDisplayDraft}{0}}
