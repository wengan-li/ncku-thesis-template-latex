...
\begin{minipage}[c][1.5cm][t]{\textwidth}
  \begin{center}
    \hspace{2.4em}
    \makebox[4.8em][r]{\Large \GetCoverStudentChiText：}
    \makebox[7.2em][l]{\Large \GetAuthorChiName} \\

    \vspace{0.5cm}

    \makebox[\textwidth][c]{\Large \GetOralApprovalChiText}\\
  \end{center}
\end{minipage}
...
\begin{minipage}[c][9.0cm][t]{\textwidth}
  \begin{center}
    \makebox[\textwidth][l]{\Large \GetOralCommitteeChiText：} \\
...
\begin{minipage}[c][3.0cm][t]{\textwidth}
  \begin{center}
    \makebox[4.8em][r]{\Large \GetOralAdvisorChiText}
    \makebox[1em][c]{\Large：}
    \makebox[7.2em][l]{\namesigdate}\\

    \vspace{1.0cm}

    \makebox[4.8em][r]{\Large \GetOralChairChiText}
    \makebox[1em][c]{\Large：}
    \makebox[7.2em][l]{\namesigdate}\\
    ...
    % Date 日期
    \makebox[\textwidth][s]{\Large \GetOralDateChiPrefix\space \GetOralChiYear 年 \GetOralChiMonth 月 \GetOralChiDay 日}
  \end{center}
\end{minipage}
