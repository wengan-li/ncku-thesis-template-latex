...
% --- 章節標題的語言和數字 ---
%
% \ChapterTitleInChi:  章節標題以全中文顯示
% 預設上章節標題是以英文來顯示 (如 Chapter 1),
% 但全中文編寫則需要顯示成中文,
% 故使用'\ChapterTitleInChi'可以顯示成中文 (如 第1章).
%
% \ChapterTitleNumInChi: 章節標題數字要使用中文數字,
% 而不是阿拉伯數字,
% 故使用'\ChapterTitleNumInChi'可以顯示成 '第一章' 而不是 '第1章'.
% \ChapterTitleNumInChi必須配合\ChapterTitleInChi來使用, 否則會無效.
