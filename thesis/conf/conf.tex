...
%
% \SetTitle %
% {國立成功大學碩博士用畢業論文LaTex模板} %
% {National Cheng Kung University (NCKU) Thesis/Dissertation Template in LaTex}
%
% or
%
% \SetChiTitle{國立成功大學碩博士用畢業論文LaTex模板}
...
% 但如果你不是國立成功大學的學生, 那本模板則不清楚 貴學校所定的規範是否要分開, 故先保留這功能.
...
\SetAbstractChiKeywords{國立成功大學畢業論文模板}{碩博士}{LaTex/XeLaTex}
