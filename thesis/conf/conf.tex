...
% 故這邊可設定你想要的符號或不需要符號
% \SetChapterTitleIndexSep % 設定'章'的符號
% \SetSectionTitleIndexSep  % 設定'節'的符號
% \SetSubSectionTitleIndexSep % 設定'小節'的符號
% \SetSubSubSectionTitleIndexSep % 設定'小小節'的符號
%
% 如想換'章'的由'Chapter 1. ABCDEF'換成'Chapter 1: ABCDEF'
% 則使用\SetChapterTitleIndexSep{:}
%
...
%\SetChapterTitleIndexSep{.}
%\SetSectionTitleIndexSep{.}
%\SetSubSectionTitleIndexSep{.}
%\SetSubSubSectionTitleIndexSep{.}
...
%\ChapterTitleNumFormat{第\StyleCNumChiNum 章}
