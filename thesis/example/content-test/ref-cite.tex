...
figure: \RefFigure{testpage:ref-cite:figure}\\
table: \RefTable{testpage:ref-cite:table}\\
equation: \RefEquation{testpage:ref-cite:eq}\\
equation with (): \RefEquationB{testpage:ref-cite:eq}\\
