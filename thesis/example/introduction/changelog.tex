...
\begin{description}
  \item[v1.3.0] 重大改版 (如果是使用直接取代舊版檔案的升級方式, 請注意以下所修改的部份有沒有影響自身的內容)\hfill
    \begin{description}
      ...
      \item[功能] \hfill
        \begin{enumerate}
          \item 增加可設定 ' (初稿)' (中文版) 和 'Draft' (英文版) 在封面和書脊
        \end{enumerate}
      \item[其他] \hfill
        \begin{enumerate}
          ...
          \item 修正錯字 'Templete' -> 'Template', 受影響的API為 '\texttt{\DisplayOralTemplate}' (原為 '\texttt{\DisplayOralTemplete}') \([Issue \#7](https://github.com/wengan-li/ncku-thesis-template-latex/issues/7)\)
