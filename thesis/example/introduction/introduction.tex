...
\begin{description}
  \item[版權 License] \hfill \\
    本著作(ncku-thesis-templete\RefBib{web:this-project:github})採用創用 CC 姓名標示-非商業性 4.0 授權條款.

    This work(ncku-thesis-templete\RefBib{web:this-project:github}) is licensed under a Creative Commons Attribution-NonCommercial 4.0 International License.
