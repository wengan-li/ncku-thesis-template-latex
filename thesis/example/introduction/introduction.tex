...
\begin{description}
  ...
  \item[版權 License] \hfill \\
    本著作(ncku-thesis-templete[\RefTo{web:this-project:homepage}])採用創用 CC 姓名標示-非商業性 4.0 授權條款.

    This work(ncku-thesis-templete[\RefTo{web:this-project:homepage}]) is licensed under a Creative Commons Attribution-NonCommercial 4.0 International License.

  \InsertCenterImage
    [scale=1.0,
      caption={CC Attribution-NonCommercial License},
      label={fig:appendix:by-nc}]
    {./example/introduction/pic/by-nc.png}
\end{description}
