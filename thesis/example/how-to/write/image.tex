% ------------------------------------------------
\StartChapter{Latex教學 - 圖片 Image}{chapter:how-to:write:image}
% ------------------------------------------------
\StartSection{介紹}
...
\StartSection{單張}
  ...
  \item
  {
    ...
    \begin{tabular}{|c|c|}
      ...
      \begin{tabular}[c]{@{}c@{}}
      \InsertImage[scale=0.1]
        {./example/how-to/write/pic/image/apple.jpg} \\ Apple
      \end{tabular} & \url{www.apple.com}  \\ \hline

      \begin{tabular}[c]{@{}c@{}}
      \InsertImage[scale=0.1]
        {./example/how-to/write/pic/image/google.png} \\ Google
      \end{tabular} & \url{www.google.com} \\ \hline
    \end{tabular}
    \end{table}
...
%    \begin{verbatim}
%    \InsertMultiImages
%    [perrow = 2, caption = {8 images and 2 image per row}]
%    {[caption = { }]{./image.png}}%
%    {[caption = { }]{./image.png}}%
%    {[caption = { }]{./image.png}}%
%    {[caption = { }]{./image.png}}%
...
%    \InsertMultiImages
%    [perrow = 2, caption = {8 images and 2 image per row}]
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY.png}}%
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY-NC.png}}%
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY-ND.png}}%
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY-SA.png}}%
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY.png}}%
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY-NC.png}}%
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY-ND.png}}%
%    {[caption = { }]{./example/how-to/write/pic/image/CC-BY-SA.png}}
