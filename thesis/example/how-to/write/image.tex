...
\section{單張}
  ...
  \begin{enumerate}
    \item
    {
      ...
      \InsertImage{1.0}{./example/how-to/write/pic/image/Cc-by_new.svg.png}
    } % End of \item{}

    \item
    {
      使用置中的版本\begin{verbatim}\InsertCenterImage{1.0}{./image.png}\end{verbatim}
      \InsertCenterImage{1.0}{./example/how-to/write/pic/image/Cc-by_new.svg.png}
    } % End of \item{}

    \item
    {
      放大比例\begin{verbatim}\InsertCenterImage{1.5}{./image.png}\end{verbatim}
      \InsertCenterImage{1.5}{./example/how-to/write/pic/image/Cc-by_new.svg.png}
    } % End of \item{}
    ...
    \item
    {
      ...
      \InsertCenterImage{0.5}{./example/how-to/write/pic/image/Cc-by_new.svg.png}
    } % End of \item{}

    \item
    {
      增加標題並去掉比例的數字\begin{verbatim}\InsertCenterImage{}{./image.png}{Little man}\end{verbatim}
      \InsertCenterImage{}{./example/how-to/write/pic/image/Cc-by_new.svg.png}{Little man}
    } % End of \item{}
    ...
    \item
    {
      ...
      \InsertCenterImage{}{./example/how-to/write/pic/image/Cc-by_new.svg.png}{Little man No.1}{fig:little-man-no.1}
    ...
    \item
    {
      ...
      \InsertCenterImage{}{./example/how-to/write/pic/image/Cc-by_new.svg.png}{Little man No.2}{fig:little-man-no.2}
    ...
    \item
    {
      ...
      \InsertCenterImage{}{./example/how-to/write/pic/image/Cc-by_new.svg.png}{Little man No.3}{fig:little-man-no.3}{45}
