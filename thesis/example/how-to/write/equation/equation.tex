...
公式(Equation)在都是一個常用的顯示方式, 雖然寫法都很固定, 但是內容可以十分豐富, 這產生大量的寫法. 而LaTeX本身就擁有豐富的有關equation功能, Microsoft Word都不一定有這麼多功能; 而且有一點Microsoft Word是做不到, 但LaTeX就很輕鬆的行為是: 你無法很簡單帶走你所寫的Equation, 拿去轉成圖片或是copy到另一個文件中.
