...
Overleaf是線上的LaTeX環境, 本模版在Overleaf Gallery有公開範本\RefBib{web:overleaf:template}.
...
\begin{description}
  \item[TeX Live (Windows / Linux)] \hfill\\
    到TeX Live網頁\RefBib{web:texlive:website}下載安裝程式, 選擇完整安裝(full scheme), 就不會缺少套件. 完整安裝需要數GB的空間和一段時間.

  \item[MacTeX (macOS)] \hfill\\
    到MacTeX網頁\RefBib{web:mactex:website}下載安裝, 內容就是macOS版的TeX Live完整安裝.
...
實際編寫自己論文時, 請在\verb|conf/conf.tex|關閉\verb|\ExampleMode|. 主文件會改用\verb|context/context.tex|; 完整教學範例包含大量圖片及附錄PDF, 重建時間會較長.
