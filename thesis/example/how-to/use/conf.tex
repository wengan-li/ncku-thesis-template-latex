...
\begin{enumerate}
  ...
  \item
  {
    ...
    另外可個別設定目錄中章節號碼跟章節題目中的分隔符號.\\
    正常在目錄中會顯示 'Chapter 1. ABCDEF' 或 '第一章. ABCDEF'\\
    但因個人喜好, 做法不一樣, 如 'Chapter 1: ABCDEF' 或 '第一章 ABCDEF'\\
    故這邊可設定你想要的符號或不需要符號\\
    \verb|\\SetChapterTitleIndexSep| 設定'章'的符號\\
    \verb|\\SetSectionTitleIndexSep| 設定'節'的符號\\
    \verb|\\SetSubSectionTitleIndexSep| 設定'小節'的符號\\
    \verb|\\SetSubSubSectionTitleIndexSep| 設定'小小節'的符號\\

    如想換'章'的由'Chapter 1. ABCDEF'換成'Chapter 1: ABCDEF'\\
    則使用\verb|\\SetChapterTitleIndexSep{:}|

    如想換'章'的由'第一章. ABCDEF'換成'第一章 ABCDEF'\\
    則使用\verb|\\SetChapterTitleIndexSep{}| 空掉內容則可.
  } % End of \item{}
