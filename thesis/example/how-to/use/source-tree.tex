...
| |
| ...           在'conf/conf.tex'中, 如果你使用了'\ExampleMode',
...
| |
| ...           在'conf/conf.tex'中, 如果你沒使用'\ExampleMode',
...
完整儲存庫(GitHub上的source code)另外包含專案README, CHANGELOG.md, 測試與發行工具; 這些不會包含在學生套件中.
