...
\ifthenelse{\OralDocument = \OralDocumentTemplete}
{
  ...
  \ifthenelse{\LangEnableChi = 1}
  {
    ...
    % Chinese version
    \input{./oral/templete/templete-chi}

    % ------------------------------------------------
    \ifthenelse{\GetLangEnableDemo = 1}
    {
      \input{./oral/templete/templete-chi-2}
      \input{./oral/templete/templete-chi-3}
      \input{./oral/templete/templete-chi-4}
    }{}
    % ------------------------------------------------
  }{}
  ...
  \ifthenelse{\GetLangEnableEng = 1}
  {
    ...
    \thispagestyle{empty}
    \input{./oral/templete/templete-eng}
  }{}
} % End of if{}
{
